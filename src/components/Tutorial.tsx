      ...
      {step.targetElement && (
        <div className="fixed inset-0 pointer-events-none z-30">
          {step.targetElement === 'energy-gauges' && (
            <div className="absolute top-32 left-4 right-4 lg:left-4 lg:right-2/3 h-64 border-2 border-yellow-400 rounded-lg animate-pulse" />
          )}
          {step.targetElement === 'grid-meter' && (
            <div className="absolute top-32 left-4 right-4 lg:left-1/3 lg:right-1/3 h-64 border-2 border-yellow-400 rounded-lg animate-pulse" />
          )}
          {step.targetElement === 'mining-button' && (
            <div className="absolute bottom-32 left-4 right-4 lg:left-4 lg:right-1/2 h-32 border-2 border-yellow-400 rounded-lg animate-pulse" />
          )}
        </div>
      )}
    </>
